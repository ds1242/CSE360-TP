	...
	public static String checkEmailAddress(String input) {
		...
		while (running) {
			...
			case 3:
				...
				if ((currentChar >= 'A' && currentChar <= 'Z') || 		// Upper case
						(currentChar >= 'a' && currentChar <= 'z') ||	// Lower case
						(currentChar >= '0' && currentChar <= '9')) {	// Lower case
					nextState = 3;
				}
		...
		case 1:
			...
			emailAddressIndexofError = currentCharNdx;		// Copy the index of the current character;
			emailAddressErrorMessage = "Invalid email address, missing @something\n";
			return emailAddressErrorMessage;

		case 2:
			// State 2 is not a final state, so we can return a very specific error message
			emailAddressIndexofError = currentCharNdx;		// Copy the index of the current character;
			emailAddressErrorMessage = "Invalid email address, missing characters after @ or '.'\n";
			return emailAddressErrorMessage;
		...
		case 4:
			...
			emailAddressIndexofError = currentCharNdx;		// Copy the index of the current character;
			emailAddressErrorMessage = "Invalid email address, characters required after '-'\n";
			return emailAddressErrorMessage;
