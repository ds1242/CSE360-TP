...
public class ControllerUserLogin {
	...
	*/
     ...
     *
	 * @param ts specifies the JavaFX Stage to be used for this GUI and it's methods
     *
	 */
	protected static void doLogin(Stage ts) {
    	...
    	User user = new User(
            ...
            theDatabase.getOneTimePassword()
        );
        ...
        if (user.getOneTimePassword()) {
            ...
            displayHomePage(ts, user);
        }
	}

	/**********
	 * <p> Method: public displayHomePage() </p>
	 *
	 * <p> Description: This method is called in order to dispatch to the correct
     * login home page. </p>
	 *
	 * @param ts specifies the JavaFX Stage to be used for this GUI and it's methods
	 *
     ...
     *
	 */
    public static void displayHomePage(Stage ts, User user) {
