...
public class User {
    ...
    public User(String userName, String password, String fn, String mn, String ln, String pfn,
    		String ea, boolean r1, boolean r2, boolean r3, boolean otp) {
    ...
    public void setOneTimePassword(boolean otp) { this.otp = otp; }
     ...
     *
     * <p> Description: This getter returns the value of the otp attribute. </p>
     *
     * @return a String of "TRUE" or "FALSE" based on state of the attribute
	 *
     */
    public boolean getOneTimePassword() { return otp; }
